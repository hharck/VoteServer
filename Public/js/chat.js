...
var socket
// Setup the socket
function socketSetup(socketName) {
	var proto = "";
	...
	socket = new WebSocket(proto + location.host + "/api/v1/chat/" + socketName);
	...
	socket.onclose = function (event) {
		...
		let text = document.createTextNode("The connection was closed at: " + new Date().toLocaleString());
		h1.appendChild(text);
		chatarea.prepend(h1);
